...
export default function Playground({ apolloVersion }) {
  return (
    <PageWithHeader
      header={
        <Container isFluid>
          <TopNav>
            ...
            <TopNav.Section>
              <TopNav.Item>
                <a href="https://github.com/magicmark/apollo-error-handling-visualizer">
                  <img
                    src="https://img.shields.io/github/stars/magicmark/apollo-error-handling-visualizer.svg?style=social&amp;label=Star"
                    alt="github"
                  />
                </a>
              </TopNav.Item>
    ...
    >
      <PageContent isFluid>
        ...
        <Box marginTop="major-4" alignX="center">
          <Text fontSize="150">
            Made by{" "}
            <Link href="https://twitter.com/mark_larah">
              Mark Larah (@mark_larah)
            </Link>{" "}
            &bull; Built with <Code>@apollo/client@{apolloVersion}</Code>
          </Text>
        </Box>
      </PageContent>
    </PageWithHeader>
